<?php 
	...
	if (checkwinner("oxoo00o00", 7) == "Player O is the Winner"){
		echo "\nSuccess";
	}else{
	...
	if (checkwinner("oxo000xxx", 8) == "Player X is the Winner"){
		echo "\nSuccess";
	}else{
	...
	if (checkwinner("x000x000x", 7) == "Player X is the Winner"){
		echo "\nSuccess";
	}else{
	...
	if (checkwinner("00x0x0x00",8) == "Player X is the Winner"){
		echo "\nSuccess";
	}else{
